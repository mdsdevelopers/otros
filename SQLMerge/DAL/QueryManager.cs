  ...
  public static class QueryManager
    {
      ...
      public static string SentenciaTextoTablas()
      {
          return "select o.name 'Tabla',c.name 'Columna', s.name 'Tipo' ,c.length 'Lenght' , c.prec 'Prec', c.isnullable 'IsNullable'  from syscolumns c, systypes s, sysobjects o where o.xtype = 'u' and s.xtype = c.xtype and o.id = c.id and o.name = ";
      }
