     ...
     private void RealizarComparacionDeFunciones()
     {
        ...
        private void GenerarScriptTablasFaltantesServidor2(List<Tabla> lista_de_tablas)
        {
            try
            {
                ...
                foreach (Tabla vista in lista_de_tablas)
                {
                    if (UsarAutenticacionDeWindowsServer1())
                    {
                        script_generado = script_generado + "GO" + "\r\n" + "\r\n" + base_1.ObtenerTextoDeTabla(vista.Nombre, Servidor()) + "\r\n" + "\r\n" + "GO" + "\r\n";
                    }
                    else
                    {
                        script_generado = script_generado + "GO" + "\r\n" + "\r\n" + base_1.ObtenerTextoDeTabla(vista.Nombre, Servidor(), Usuario(), Password()) + "\r\n" + "\r\n" + "GO" + "\r\n";
                    }
                }
        ...
        private void GenerarScriptTablasFaltantesServidor1(List<Tabla> lista_de_tablas)
        {
            try
            {
                ...
                foreach (Tabla vista in lista_de_tablas)
                {
                    if (UsarAutenticacionDeWindowsServer1())
                    {
                        script_generado = script_generado + "GO" + "\r\n" + "\r\n" + base_2.ObtenerTextoDeTabla(vista.Nombre, Servidor2()) + "\r\n" + "\r\n" + "GO" + "\r\n";
                    }
                    else
                    {
                        script_generado = script_generado + "GO" + "\r\n" + "\r\n" + base_2.ObtenerTextoDeTabla(vista.Nombre, Servidor2(), Usuario2(), Password2()) + "\r\n" + "\r\n" + "GO" + "\r\n";
                    }
                }
